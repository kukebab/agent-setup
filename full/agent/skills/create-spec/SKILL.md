...
Generate a structured spec doc before non-trivial work. Saves to `agent/memory/outputs/specs/`.
...
File: `agent/memory/outputs/specs/YYYY-MM-DD_<feature-slug>.md`
...
**Customer (if applicable):** [[agent/memory/projects/<name>]]
**ETA:** [target date]
...
- Related: [[agent/memory/wiki/<topic>]]
- Customer context: [[agent/memory/projects/<name>]]
```

### 3. Save and confirm

```
Spec saved: agent/memory/outputs/specs/YYYY-MM-DD_<slug>.md
