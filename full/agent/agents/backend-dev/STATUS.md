...
- Spec'd PDF export endpoint with Maya. Saved to `agent/memory/outputs/specs/2026-05-03_pdf-export-mvp.md`.
...
- Post-mortem: see `agent/memory/learnings/mistakes.md` MISTAKES (2026-04-20) — gap was lack of conflict regression tests, now closing.
