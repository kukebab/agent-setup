...
File: `memory/outputs/research/YYYY-MM-DD_<topic-slug>.md`
...
**Driver:** [why we needed this — link to relevant wiki/STATE.md]
...
If the research surfaced durable knowledge (not tied to a specific moment), create or update a `wiki/<topic>.md` page that summarizes the durable parts. Cite the research output as a source.

### 7. Confirm to user

```
Research saved: memory/outputs/research/YYYY-MM-DD_<slug>.md
