...
File: `agent-os/skills/<name>/SKILL.md`
...
`agent-os/agents/<name>.md` — frontmatter + system prompt + dispatch rules.

Use `agent-os/agents/backend-dev.md` as template.

### 3. Create the state folder

`agent-os/agents/<name>/` with 4 files:
